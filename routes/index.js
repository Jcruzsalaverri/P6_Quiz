...
router.get('/quizzes/:quizId(\\d+)/edit',
    sessionController.loginRequired, //si la persona a hecho login ejecutamos lo siguiente
    quizController.adminOrAuthorRequired,// o eres el admin o eres el autor
	quizController.edit); //manda un formulario html
...
router.get('/quizzes/:quizId(\\d+)/tips/:tipId(\\d+)/edit',
    sessionController.loginRequired, //si la persona a hecho login ejecutamos lo siguiente
    tipController.adminOrAuthorRequired,// o eres el admin o eres el autor
	tipController.edit); //manda un formulario html
