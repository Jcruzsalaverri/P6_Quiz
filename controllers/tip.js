...
exports.adminOrAuthorRequired = (req, res, next)=>{ //esto es un middleware , función recibe req del usuario , resp usuario y next para

 const isAdmin = !!req.session.user.isAdmin; //por si es booleano o algo
...
exports.edit = (req, res, next)=>{
    ...
    const {quiz, tip} = req; // es equivalente a  const quiz = req.quiz; y const tip = req.tip;
...
//ejs es un motor de templates (no usamos html)